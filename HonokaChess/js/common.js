...
com.loadImages = function(){
	...
	//绘制棋盘
	com.bgImg = new Image();
	com.bgImg.src  = "./images/bg.png";
	
	//提示点
	com.dotImg = new Image();
	com.dotImg.src  = "./images/dot.png";
	
	//棋子
	for (var i in com.args){
		com[i] = {};
		com[i].img = new Image();
		com[i].img.src = "./images/"+ com.args[i].img +".png";
	}
	
	//棋子外框
	com.paneImg = new Image();
	com.paneImg.src  = "./images/r_box.png";
	
	document.getElementsByTagName("body")[0].style.background= "url(./images/bg.jpg)";
